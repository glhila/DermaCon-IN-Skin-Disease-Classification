...
def train_model():
    ...
    # -------------------
    torch.save(model.state_dict(), "mobilenetv2_qat_state.pth")
    ...
    torch.save(int8_model, "mobilenetv2_int8.pt")  # full module, easy to load
    print(f"{YELLOW}🧊 INT8 model saved as mobilenetv2_int8.pt{ENDC}")

    # (Optional) also save the INT8 state_dict if you want:
    torch.save(int8_model.state_dict(), "mobilenetv2_int8.pth")
    print(f"{YELLOW}🧊 INT8 state_dict saved as mobilenetv2_int8.pth{ENDC}")
